...
int main() {
  ...
  char* filename2 = static_cast<char *>(vm_map(nullptr, 2));
  char* filename3 = static_cast<char *>(vm_map(nullptr, 1));
	char* filename4 = static_cast<char *>(vm_map(nullptr, 0));
  char* filename5 = static_cast<char *>(vm_map(nullptr, 2));
  char* filename6 = static_cast<char *>(vm_map(nullptr, 1));
